...
export default function SignInModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-sm rounded-2xl bg-[var(--bg-elev)] border border-white/10 shadow-2xl"
          ...
          <div className="p-6 space-y-4">
            ...
            <label className="block">
              ...
              <input
                ...
                className="mt-1 w-full rounded-md bg-[var(--bg)] border border-white/10 px-3 py-2.5 text-sm outline-none focus:border-brand-500"
              />
            </label>
            <button
              onClick={send}
