...
- `HeavyPageNotice` (component) — host-only sun-tinted card in CanvasFloatingPanel once the current page holds `HEAVY_PAGE_SHAPES` (3000) shapes: "New page" (same path as PagesTabBar's button, naming dialog included) or "Tidy page". × snoozes it for that page until 2000 more shapes.
...
npm test             # vitest run (205 tests across 20 files)
